...
function OSJDeveloperTools(){
	...
	this.cancelCreateProject = function(){
		...
		$("#osj-dev-tools-new-project-application-name").val("");
...
function open_osj_dev_tools(){
	Import.this('<script src="system/applications/osj_dev_tools/script/ace-editor/ace.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/Control.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/Form.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/Label.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/Button.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/TextBox.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/ToolBox.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/GenerateLayout.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/script/ProjectExplorer.js"></script>');
	Import.this('<script src="system/applications/osj_dev_tools/ExampleForm.js"></script>');
	proExp.loadDirectory();
}