<?php
	...
	function create_project($dir, $project_name, $program_id, $apps_name, $folder_project){
		...
		if(!mkdir($dir."/layout")){
			...
			create_layout($dir, $project_name, $program_id, $folder_project, $apps_name);
		}
		if(!mkdir($dir."/script")){
		...
		create_run_file($dir, $project_name, $program_id, $folder_project, $apps_name);
	}
	...
	function create_layout($dir, $project_name, $program_id, $folder_project, $apps_name){
	...
	<div class="ui-widget-header">
		<div class="application-header">
			...
			<div align="center"><span id="form-name" style="margin-left:-50px;">'.$apps_name.'</span></div>
		</div>
	</div>
...
function create_run_file($dir, $project_name, $program_id, $folder_project, $apps_name){
...
function setMenu_'.$program_id.'(){
	...
	var valMenu = "<span id=top-menu-item0 class=top-menu-item>'.$apps_name.'</span>"+
        "<ul id=top-menu-item0-down class=top-menu-item-down>"+
			...
			"<li onclick=close_'.$program_id.'(proIdApps)>Quit '.$apps_name.'</li>"+
        "</ul>";
