...
function getPropertiesValue(){
    ...
    valProperties += "<tr><td width='50%'><span>ID</span></td><td width='50%'><input class=input id=id type=text value="+ctrl.id+" onkeyup=SetPropertiesValue()></td></tr>";
    valProperties += "<tr><td width='50%'><span>Width</span></td><td width='50%'><input class=input id=width type=text value="+ctrl.width+" onkeyup=SetPropertiesValue()></td></tr>";
	valProperties += "<tr><td width='50%'><span>Height</span></td><td width='50%'><input class=input id=height type=text value="+ctrl.height+" onkeyup=SetPropertiesValue()></td></tr>";
	valProperties += "<tr><td width='50%'><span>Position Top</span></td><td width='50%'><input class=input id=posTop type=text value="+ctrl.positionTop+" onkeyup=SetPropertiesValue()></td></tr>";
	valProperties += "<tr><td width='50%'><span>Position Left</span></td><td width='50%'><input class=input id=posLeft type=text value="+ctrl.positionLeft+" onkeyup=SetPropertiesValue()></td></tr>";
	valProperties += "<tr><td width='50%'><span>Text</span></td><td width='50%'><input class=input id=text type=text value='"+ctrl.text+"' onkeyup=SetPropertiesValue()></td></tr>";

    if(FString.countWord(ToolBoxSelected, "container") <= 0){
    valProperties += "<tr><td width='50%'><span>Padding Top</span></td><td width='50%'><input class=input id=paddingTop type=text value="+ctrl.paddingTop+" onkeyup=SetPropertiesValue()></td></tr>";
    valProperties += "<tr><td width='50%'><span>Padding Right</span></td><td width='50%'><input class=input id=paddingRight type=text value="+ctrl.paddingRight+" onkeyup=SetPropertiesValue()></td></tr>";
    valProperties += "<tr><td width='50%'><span>Padding Bottom</span></td><td width='50%'><input class=input id=paddingBottom type=text value="+ctrl.paddingBottom+" onkeyup=SetPropertiesValue()></td></tr>";
    valProperties += "<tr><td width='50%'><span>Padding Left</span></td><td width='50%'><input class=input id=paddingLeft type=text value="+ctrl.paddingLeft+" onkeyup=SetPropertiesValue()></td></tr>";
    }
