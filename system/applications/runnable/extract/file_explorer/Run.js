...
function init_explorer(){
	Import.this("<script src='system/applications/runnable/extract/file_explorer/script/ExplorerAction.js'></script>");
	Import.this("<script src='system/applications/runnable/extract/file_explorer/script/ExplorerSelect.js'></script>");
	Import.this("<script src='system/applications/runnable/extract/file_explorer/script/ExplorerDirectory.js'></script>");
	ExplorerEvent();
...
function register_explorer(){
	$.post("system/applications/runnable/extract/file_explorer/layout/file_explorer.html", function(data){
