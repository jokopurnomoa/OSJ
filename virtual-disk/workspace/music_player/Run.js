...
function init_music_player(){
    ...
    Resizable.set("music_player", null, 261, 300);
	...
	var libs_music_player = '<link rel="stylesheet" type="text/css" href="system/kernel/style/player-skin/pink.flag/jplayer.pink.flag.css"/><script src="system/applications/music_player/script/player/jquery.jplayer.min.js"></script><script src="system/applications/music_player/script/player/jplayer.playlist.min.js"></script>';
	if(FString.countWord($("head").html(),libs_music_player) <= 0)
		$("head").append(libs_music_player);
}
